                            ...
                            ? Column(
                                ...
                                children: [
                                  ...
                                  BlocBuilder(
                                      ...
                                      builder: (context, state) {
                                        return savedAll.state.listDataMap.isNotEmpty
                                            ? SizedBox(
                                                      ...
                                                      return GestureDetector(
                                                        onLongPress: () {
                                                          ModalText(
                                                              context,
                                                              'Konfirmasi',
                                                              'Apakah Anda Yakin akan menghapus Postingan ini dari Penyimpanan Anda ?',
                                                              [
                                                                IconsButton(
                                                                  onPressed: () async {
                                                                    // Show loading dialog
                                                                    ...
                                                                    final response = await Api()
                                                                        .delSaved(savedAll.state
                                                                                .listDataMap[index]
                                                                            ['post_saved_id']);

                                                                    // Make sure context is still valid before dismissing dialog
                                                        ...
                                                        onTap: () {
                                                          choosePostIndex(
                                                              savedAll.state.listDataMap[index]);
                                                          // loadImgPostIndex(savedAll.state.listDataMap[index]['post_id']);
                                                          loadNearestPostIndex(
                                                              savedAll.state.listDataMap[index]
                                                                  ['venue']['venue_x_coordinat'],
                                                              savedAll.state.listDataMap[index]
                                                                  ['venue']['venue_y_coordinat'],
                                                              '');
                                                          loadReviewPostIndex(savedAll
                                                              .state.listDataMap[index]['post_id']);
                                                          Navigator.pushNamed(
                                                              context, '/detail-post');
                                                        },
                                                        child: Container(
                                                            ...
                                                            child: Row(
                                                              children: [
                                                                savedAll.state.listDataMap[index][
                                                                    ...
                                                                    ? CachedNetworkImage(
                                                                        imageUrl:
                                                                            "${Url().urlPict}${savedAll.state.listDataMap[index]['img'][0]['images_file'] ?? ''}",
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      Column(
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            '${savedAll.state.listDataMap[index]['post_title']}',
                                                                            style: GoogleFonts
                                                                                .montserrat(
                                                                                    fontSize: 16,
                                                                                    color:
                                                                          ...
                                                                          savedAll.state.listDataMap[
                                                                                          index]
                                                                                      ['venue'] !=
                                                                                  null
                                                                              ? Text(
                                                                                  '${savedAll.state.listDataMap[index]['venue']['venue_addr'] ?? ''}',
                                                                          ...
                                                                          Column(
                                                                            ...
                                                                            children: [
                                                                              savedAll.state.listDataMap[
                                                                                  ...
                                                                                  ? Row(
                                                                                      children: [
                                                                                        ...
                                                                                        Text(
                                                                                          '${(calculateDistance(double.parse(latitudeUserCB.state), double.parse(longitudeUserCB.state), double.parse(savedAll.state.listDataMap[index]['venue']['venue_x_coordinat'].toString()), double.parse(savedAll.state.listDataMap[index]['venue']['venue_y_coordinat'].toString()))).toStringAsFixed(0)} km',
                                                                                          style: GoogleFonts.roboto(
                                                                                              fontSize:
                                                                                                  12,
                                                                                              color:
                                                                              ...
                                                                              savedAll.state.listDataMap[
                                                                                      ...
                                                                                      null
                                                                                  ? Text(
                                                                                      '${savedAll.state.listDataMap[index]['review'].length} reviews',
                                                                                      style: GoogleFonts.roboto(
                                                                                          fontSize:
                                                                                              12,
                                                                                          color:
                                                                            ...
                                                                            children: [
                                                                              Text(
                                                                                savedAll.state.listDataMap[index]
                                                                                        ...
                                                                                        savedAll
                                                                                                .state
                                                                                                .listDataMap[index]['cost']
                                                                                                .length >
                                                                                            0
                                                                                    ? 'IDR${(int.parse(savedAll.state.listDataMap[index]['cost'][0]['cost_price'].toString()) / 1000).toStringAsFixed(0)} K'
                                                                                    : '-',
                                                                                style: GoogleFonts
                                                                                    .montserrat(
                                                                                        fontSize:
                                                                              ...
                                                                              Text(
                                                                                '${savedAll.state.listDataMap[index]['cost'] != null && savedAll.state.listDataMap[index]['cost'].length > 0 ? savedAll.state.listDataMap[index]['cost'][0]['cost_name'] : ''}',
                                                                                style: GoogleFonts.roboto(
                                                                                    fontSize: 10,
                                                                                    color:
                                                                                        WADarkColor,
