...
import 'package:hai_tegal/service/api.dart'
    as api_service; // Added prefix to resolve naming conflict
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              BlocBuilder(
                                  ...
                                  builder: (context, state) {
                                    return isChange.state == 1
                                        ? TextButton(
                                            onPressed: () async {
                                              // Show loading indicator
                                              ModalContainer(context, 'Updating profile...',
                                                  CircularProgressIndicator(), []);

                                              final response = await api_service.Api()
                                                  .changeProfile(
                                                      emailCont.text,
                                                      usernameCont.text,
                                                      imgProfile.state,
                                              ...
                                              if (response.success) {
                                                AlertText(context, WAAccentColor, WALightColor,
                                                    response.message);
                                                userDetailMB.changeVal(response.data);
                                              } else {
                                                AlertText(context, WADangerColor, WALightColor,
                                                    response.message);
                                              }
                                            },
                                            child: Text(
                          ...
                          BlocBuilder(
                              ...
                              builder: (context, state) {
                                return Align(
                                  ...
                                  child: uploadSinglePic(
                                      context, imgProfile, 'assets/img/profile_img.png', false,
                                      isGallery: true),
                                );
                              }),
                          SizedBox(
                                      ...
                                      ModalContainer(
                                          ...
                                          Container(
                                            ...
                                            child: DatePickerWidget(
                                              ...
                                              firstDate: DateTime(DateTime.now().year - 80, 1, 13),
                                            ...
                                            IconsButton(
                                                onPressed: () {
                                                  if (dateBirth.state == '') {
                                                    ...
                                                    if (dateBirth.state !=
                                                        userDetailMB.state['user_date_birth']) {
                                                      isChange.changeVal(1);
                                                    } else {
                                                      isChange.defaultVal();
                                                    }
                            ...
                            child: GestureDetector(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    color: WADangerColor,
                                    border: Border.all(color: WADangerColor),
                                    boxShadow: [
                                      BoxShadow(
